...
class CoralBleachingDatasetInference(Dataset):
    """
...
def inference(N_CLASSES, device):
    ...
    for run_name, dataset_folder, checkpoint_folder in tqdm(inference_runs, desc="Overall Inference Runs"):
        ...
        try:
            full_dataset = CoralBleachingDatasetInference(root=root, transform=inference_transform)
